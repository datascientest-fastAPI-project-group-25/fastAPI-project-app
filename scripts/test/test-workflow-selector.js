...
function getWorkflowFiles() {
  ...
  try {
    ...
    console.error(`${colors.red}Error reading workflow directory: ${error.message}${colors.reset}`);
    return [];
  }
}

// Display workflow selection menu
async function selectWorkflow(workflows) {
...
// Select event type
async function selectEventType() {
  return new Promise((resolve) => {
